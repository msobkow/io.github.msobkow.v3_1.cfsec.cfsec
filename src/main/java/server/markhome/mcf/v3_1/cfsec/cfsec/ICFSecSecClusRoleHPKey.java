// Description: Java 25 interface for a SecClusRole history primary key object
...
/**
 *	ICFSecSecClusRoleHPKey History Primary Key interface for SecClusRole has CodeVis Protected, meaning that any only user interfaces and application code specific to the defining schema can access it.
 *		requiredSecClusRoleId	Required object attribute SecClusRoleId. */
public interface ICFSecSecClusRoleHPKey
{
