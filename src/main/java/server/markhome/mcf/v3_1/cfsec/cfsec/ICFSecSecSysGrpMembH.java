// Description: Java 25 interface for a SecSysGrpMemb history object
...
/**
 *	ICFSecSecSysGrpMembH provides access to history records matching the CFSecSecSysGrpMemb object change history.
 */
public interface ICFSecSecSysGrpMembH
{
