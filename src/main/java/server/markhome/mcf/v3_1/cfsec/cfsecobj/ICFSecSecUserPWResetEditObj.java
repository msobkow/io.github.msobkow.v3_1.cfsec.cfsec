// Description: Java 25 Instance Edit Object interface for CFSec SecUserPWReset.
...
public interface ICFSecSecUserPWResetEditObj
	extends ICFSecSecUserPWResetObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFSecSecUserPWResetObj.
	 */
	ICFSecSecUserPWResetObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFSecSecUserPWResetObj.
	 */
	ICFSecSecUserPWResetObj getOrigAsSecUserPWReset();
	 ...
	 */
	ICFSecSecUserPWResetObj create();

	/*
	 *	Update the instance.
	 */
	CFSecSecUserPWResetEditObj update();

	/*
	 *	Delete the instance.
	 */
	CFSecSecUserPWResetEditObj deleteInstance();
