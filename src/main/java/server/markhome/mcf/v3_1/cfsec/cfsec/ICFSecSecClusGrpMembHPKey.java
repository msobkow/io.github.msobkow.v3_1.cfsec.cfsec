// Description: Java 25 interface for a SecClusGrpMemb history primary key object
...
/**
 *	ICFSecSecClusGrpMembHPKey History Primary Key interface for SecClusGrpMemb has CodeVis Protected, meaning that any only user interfaces and application code specific to the defining schema can access it.
