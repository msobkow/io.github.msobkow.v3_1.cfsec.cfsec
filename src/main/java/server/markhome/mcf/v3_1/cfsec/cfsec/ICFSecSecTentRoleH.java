// Description: Java 25 interface for a SecTentRole history object
...
/**
 *	ICFSecSecTentRoleH provides access to history records matching the CFSecSecTentRole object change history.
 */
public interface ICFSecSecTentRoleH
{
