...
// Description: Java 25 Factory service implementation for ISOTZone buffers
...
/*
 *	Java 25 Factory service implementation for ISOTZone buffers.
 */
@Service("cfsec31BuffISOTZoneFactoryService")
public class CFSecBuffISOTZoneFactoryService
	implements ICFSecISOTZoneFactory
{
	public CFSecBuffISOTZoneFactoryService() {
	}
