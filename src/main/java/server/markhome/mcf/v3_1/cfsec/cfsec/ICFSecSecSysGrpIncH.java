// Description: Java 25 interface for a SecSysGrpInc history object
...
/**
 *	ICFSecSecSysGrpIncH provides access to history records matching the CFSecSecSysGrpInc object change history.
 */
public interface ICFSecSecSysGrpIncH
{
