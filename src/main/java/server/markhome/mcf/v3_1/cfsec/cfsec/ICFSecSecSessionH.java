// Description: Java 25 interface for a SecSession history object
...
/**
 *	ICFSecSecSessionH provides access to history records matching the CFSecSecSession object change history.
 */
public interface ICFSecSecSessionH
{
