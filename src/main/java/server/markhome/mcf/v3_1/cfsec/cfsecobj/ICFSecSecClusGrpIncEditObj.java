// Description: Java 25 Instance Edit Object interface for CFSec SecClusGrpInc.
...
public interface ICFSecSecClusGrpIncEditObj
	extends ICFSecSecClusGrpIncObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFSecSecClusGrpIncObj.
	 */
	ICFSecSecClusGrpIncObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFSecSecClusGrpIncObj.
	 */
	ICFSecSecClusGrpIncObj getOrigAsSecClusGrpInc();
	 ...
	 *	Delete the instance.
	 */
	CFSecSecClusGrpIncEditObj deleteInstance();
