// Description: Java 25 implementation of a TableInfo by SchemaBkCodeIdx index key buffer
	...
	implements ICFSecTableInfoBySchemaBkCodeIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffTableInfoBySchemaBkCodeIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
