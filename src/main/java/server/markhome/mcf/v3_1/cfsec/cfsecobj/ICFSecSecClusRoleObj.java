// Description: Java 25 Object interface for CFSec SecClusRole.
	...
	extends ICFLibAnyObj
{
	 ...
	 *
	 *	@return	CFSecSecClusRoleObj instance which should be subsequently referenced.
	 */
	ICFSecSecClusRoleObj realise();
	 ...
	 *
	 *	@return	ICFSecSecClusRoleObj the reference to the cached or read (realised) instance.
	 */
	ICFSecSecClusRoleObj read();
	 ...
	 *	@return	ICFSecSecClusRoleObj the reference to the cached or read (realised) instance.
	 */
	ICFSecSecClusRoleObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this SecClusRole instance.
	 *
	 *	@return	The newly locked ICFSecSecClusRoleEditObj edition of this instance.
	 */
	ICFSecSecClusRoleEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFSecSecClusRoleEditObj edition of this instance.
	 */
	ICFSecSecClusRoleEditObj getEdit();

	/**
	 *	Get the current edition of this SecClusRole instance as a ICFSecSecClusRoleEditObj.
	 *
	 *	@return	The ICFSecSecClusRoleEditObj edition of this instance.
	 */
	ICFSecSecClusRoleEditObj getEditAsSecClusRole();

	/**
	 *	Get the ICFSecSecClusRoleTableObj table cache which manages this instance.
	 *
	 *	@return	ICFSecSecClusRoleTableObj table cache which manages this instance.
	 */
	ICFSecSecClusRoleTableObj getSecClusRoleTable();
	...
	/**
	 *	Get the ICFSecSecClusRole instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecSecClusRole instance which currently backs this object.
	 */
	ICFSecSecClusRole getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecSecClusRole value );
	 ...
	 *	@return	ICFSecSecClusRole instance which currently backs this object.
	 */
	ICFSecSecClusRole getSecClusRoleRec();
