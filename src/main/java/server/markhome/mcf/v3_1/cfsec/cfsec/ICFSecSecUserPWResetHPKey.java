// Description: Java 25 interface for a SecUserPWReset history primary key object
...
/**
 *	ICFSecSecUserPWResetHPKey History Primary Key interface for SecUserPWReset has CodeVis Protected, meaning that any only user interfaces and application code specific to the defining schema can access it.
 *		requiredSecUserId	Required object attribute SecUserId. */
public interface ICFSecSecUserPWResetHPKey
{
