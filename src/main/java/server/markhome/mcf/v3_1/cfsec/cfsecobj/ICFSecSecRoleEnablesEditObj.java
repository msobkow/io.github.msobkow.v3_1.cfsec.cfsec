// Description: Java 25 Instance Edit Object interface for CFSec SecRoleEnables.
...
public interface ICFSecSecRoleEnablesEditObj
	extends ICFSecSecRoleEnablesObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFSecSecRoleEnablesObj.
	 */
	ICFSecSecRoleEnablesObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFSecSecRoleEnablesObj.
	 */
	ICFSecSecRoleEnablesObj getOrigAsSecRoleEnables();
	 ...
	 *	Delete the instance.
	 */
	CFSecSecRoleEnablesEditObj deleteInstance();
