// Description: Java 25 interface for a SecSysGrp history object
...
/**
 *	ICFSecSecSysGrpH provides access to history records matching the CFSecSecSysGrp object change history.
 */
public interface ICFSecSecSysGrpH
{
