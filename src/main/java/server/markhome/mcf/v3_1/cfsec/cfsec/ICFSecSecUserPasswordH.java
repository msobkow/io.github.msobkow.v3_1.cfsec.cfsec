// Description: Java 25 interface for a SecUserPassword history object
...
/**
 *	ICFSecSecUserPasswordH provides access to history records matching the CFSecSecUserPassword object change history.
 */
public interface ICFSecSecUserPasswordH
{
