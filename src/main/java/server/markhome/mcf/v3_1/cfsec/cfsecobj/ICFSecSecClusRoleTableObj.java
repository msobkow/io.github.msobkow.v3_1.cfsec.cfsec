...
public interface ICFSecSecClusRoleTableObj
{
	 ...
	 */
	ICFSecSecClusRoleObj readSecClusRole( $implCommaIJavaOptAtomType$ pkey );
	...
	ICFSecSecClusRoleObj readCachedSecClusRole( $implCommaIJavaOptAtomType$ pkey );

	public void reallyDeepDisposeSecClusRole( ICFSecSecClusRoleObj obj );

	void deepDisposeSecClusRole( $implCommaIJavaOptAtomType$ pkey );

	/**
	 *	Internal use only.
	 */
	ICFSecSecClusRoleObj lockSecClusRole( $implCommaIJavaOptAtomType$ pkey );
