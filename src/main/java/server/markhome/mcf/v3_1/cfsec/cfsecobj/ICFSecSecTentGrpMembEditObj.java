// Description: Java 25 Instance Edit Object interface for CFSec SecTentGrpMemb.
...
public interface ICFSecSecTentGrpMembEditObj
	extends ICFSecSecTentGrpMembObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFSecSecTentGrpMembObj.
	 */
	ICFSecSecTentGrpMembObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFSecSecTentGrpMembObj.
	 */
	ICFSecSecTentGrpMembObj getOrigAsSecTentGrpMemb();
	 ...
	 */
	ICFSecSecTentGrpMembObj create();

	/*
	 *	Update the instance.
	 */
	CFSecSecTentGrpMembEditObj update();

	/*
	 *	Delete the instance.
	 */
	CFSecSecTentGrpMembEditObj deleteInstance();
