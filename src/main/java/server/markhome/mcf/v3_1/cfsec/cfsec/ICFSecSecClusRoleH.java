// Description: Java 25 interface for a SecClusRole history object
...
/**
 *	ICFSecSecClusRoleH provides access to history records matching the CFSecSecClusRole object change history.
 */
public interface ICFSecSecClusRoleH
{
