// Description: Java 25 Instance Edit Object interface for CFSec SecClusGrpMemb.
...
public interface ICFSecSecClusGrpMembEditObj
	extends ICFSecSecClusGrpMembObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFSecSecClusGrpMembObj.
	 */
	ICFSecSecClusGrpMembObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFSecSecClusGrpMembObj.
	 */
	ICFSecSecClusGrpMembObj getOrigAsSecClusGrpMemb();
	 ...
	 */
	ICFSecSecClusGrpMembObj create();

	/*
	 *	Update the instance.
	 */
	CFSecSecClusGrpMembEditObj update();

	/*
	 *	Delete the instance.
	 */
	CFSecSecClusGrpMembEditObj deleteInstance();
