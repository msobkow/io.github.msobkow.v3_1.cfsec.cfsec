// Description: Java 25 Instance Edit Object interface for CFSec SecSysRole.
...
public interface ICFSecSecSysRoleEditObj
	extends ICFSecSecSysRoleObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFSecSecSysRoleObj.
	 */
	ICFSecSecSysRoleObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFSecSecSysRoleObj.
	 */
	ICFSecSecSysRoleObj getOrigAsSecSysRole();
	 ...
	 *	Delete the instance.
	 */
	CFSecSecSysRoleEditObj deleteInstance();
