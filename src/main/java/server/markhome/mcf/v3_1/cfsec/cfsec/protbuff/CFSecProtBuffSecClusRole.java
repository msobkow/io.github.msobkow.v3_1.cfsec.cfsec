...
public class CFSecProtBuffSecClusRole
	implJustProtements ICFSecSecClusRole, Comparable<Object>, Serializable
{
	protected $implJustProtIJavaAtomType$ requiredSecClusRoleId;
	...
	public List<ICFSecSecClusRoleMemb> getOptionalChildrenMembByGrp() {
		...
		ICFSecSecClusRoleMemb[] targetArr = targetTable.readDerivedBy$declJustProtReadTableSuffix$(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization()$implCommaSetPassAttrArgColumn$);
		if( targetArr != null ) {
	...
	@Override
	public void setJustProtRequiredOwnerCluster($declSetArgColumn$) {
		ICFSecSchema targetBackingCFSec = ICFSecSchema.getBackingCFSec();
		if (targetBackingCFSec == null) {
...
$implJustProtColumnGetter$$implJustProtColumnSetter$$implJustProtColumnGetter$$implJustProtColumnSetter$
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFSecProtSecClusRoleHPKey rhs ) {$implJustProtHPKeyCompareToRequiredRevision$
			if (getRequiredSecClusRoleId() != null) {
				if (rhs.getRequiredSecClusRoleId() != null) {
					cmp = getRequiredSecClusRoleId().compareTo( rhs.getRequiredSecClusRoleId() );
					if( cmp != 0 ) {
