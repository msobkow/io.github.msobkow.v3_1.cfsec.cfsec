// Description: Java 25 interface for a SecTentRoleMemb history object
...
/**
 *	ICFSecSecTentRoleMembH provides access to history records matching the CFSecSecTentRoleMemb object change history.
 */
public interface ICFSecSecTentRoleMembH
{
