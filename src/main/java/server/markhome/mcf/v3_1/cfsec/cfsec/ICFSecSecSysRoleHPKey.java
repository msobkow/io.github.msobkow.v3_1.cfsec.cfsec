...
/**
 *	ICFSecSecSysRoleHPKey History Primary Key interface for SecSysRole has CodeVis Public, meaning that any user interface or referencing schema can access it.
