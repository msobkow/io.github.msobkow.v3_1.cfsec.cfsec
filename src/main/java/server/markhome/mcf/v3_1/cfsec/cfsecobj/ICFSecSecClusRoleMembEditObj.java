// Description: Java 25 Instance Edit Object interface for CFSec SecClusRoleMemb.
...
public interface ICFSecSecClusRoleMembEditObj
	extends ICFSecSecClusRoleMembObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFSecSecClusRoleMembObj.
	 */
	ICFSecSecClusRoleMembObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFSecSecClusRoleMembObj.
	 */
	ICFSecSecClusRoleMembObj getOrigAsSecClusRoleMemb();
	 ...
	 */
	ICFSecSecClusRoleMembObj create();

	/*
	 *	Update the instance.
	 */
	CFSecSecClusRoleMembEditObj update();

	/*
	 *	Delete the instance.
	 */
	CFSecSecClusRoleMembEditObj deleteInstance();
