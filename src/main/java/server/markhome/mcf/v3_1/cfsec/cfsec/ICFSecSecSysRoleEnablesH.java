// Description: Java 25 interface for a SecSysRoleEnables history object
...
/**
 *	ICFSecSecSysRoleEnablesH provides access to history records matching the CFSecSecSysRoleEnables object change history.
 */
public interface ICFSecSecSysRoleEnablesH
{
