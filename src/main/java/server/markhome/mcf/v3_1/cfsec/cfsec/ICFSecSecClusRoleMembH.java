// Description: Java 25 interface for a SecClusRoleMemb history object
...
/**
 *	ICFSecSecClusRoleMembH provides access to history records matching the CFSecSecClusRoleMemb object change history.
 */
public interface ICFSecSecClusRoleMembH
{
