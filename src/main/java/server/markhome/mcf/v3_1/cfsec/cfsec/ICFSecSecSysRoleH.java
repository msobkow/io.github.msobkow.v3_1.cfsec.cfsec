// Description: Java 25 interface for a SecSysRole history object
...
/**
 *	ICFSecSecSysRoleH provides access to history records matching the CFSecSecSysRole object change history.
 */
public interface ICFSecSecSysRoleH
{
