...
// Description: Java 25 DbIO interface for TableInfo.
...
/*
 *	CFSecTableInfoTable database interface for TableInfo has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFSecTableInfoTable
{
	 ...
	 */
	ICFSecTableInfo createTableInfo( ICFSecAuthorization Authorization,
		ICFSecTableInfo rec );
	 ...
	 */
	ICFSecTableInfo updateTableInfo( ICFSecAuthorization Authorization,
		ICFSecTableInfo rec );
	 ...
	 */
	void deleteTableInfo( ICFSecAuthorization Authorization,
		ICFSecTableInfo rec );
	/**
	 ...
	 */
	ICFSecTableInfo[] readAllDerived( ICFSecAuthorization Authorization );
	 ...
	 */
	ICFSecTableInfo[] readAllRec( ICFSecAuthorization Authorization );
