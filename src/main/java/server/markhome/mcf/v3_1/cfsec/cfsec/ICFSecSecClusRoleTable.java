...
// Description: Java 25 DbIO interface for SecClusRole.
...
/*
 *	CFSecSecClusRoleTable database interface for SecClusRole has CodeVis Protected, meaning that any only user interfaces and application code specific to the defining schema can access it.
 */
public interface ICFSecSecClusRoleTable
{
	 ...
	 */
	ICFSecSecClusRole createSecClusRole( ICFSecAuthorization Authorization,
	 ...
	 */
	ICFSecSecClusRole updateSecClusRole( ICFSecAuthorization Authorization,
		ICFSecSecClusRole rec );
	 ...
	 */
	void deleteSecClusRole( ICFSecAuthorization Authorization,
		ICFSecSecClusRole rec );
	/**
	 ...
	 */
	ICFSecSecClusRole[] readAllDerived( ICFSecAuthorization Authorization );
	 ...
	 */
	ICFSecSecClusRole[] readAllRec( ICFSecAuthorization Authorization );
