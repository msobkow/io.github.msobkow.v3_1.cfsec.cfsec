// Description: Java 25 interface for a SecClusRoleMemb history primary key object
...
/**
 *	ICFSecSecClusRoleMembHPKey History Primary Key interface for SecClusRoleMemb has CodeVis Protected, meaning that any only user interfaces and application code specific to the defining schema can access it.
 *		requiredSecClusRoleId	Required object attribute SecClusRoleId.
 *		requiredLoginId	Required object attribute LoginId. */
public interface ICFSecSecClusRoleMembHPKey
{
