...
public class CFSecSecTentGrpIncTableObj
	implements ICFSecSecTentGrpIncTableObj
{
	protected ICFSecSchemaObj schema;
	protected static int runtimeClassCode = ICFSecSecTentGrpInc.CLASS_CODE;
	protected static final int backingClassCode = ICFSecSecTentGrpInc.CLASS_CODE;
	...
	public CFSecSecTentGrpIncTableObj() {
		schema = null;
	...
	public CFSecSecTentGrpIncTableObj( ICFSecSchemaObj argSchema ) {
	...
	static void setRuntimeClassCode(int argNewClassCode ) {
		if (argNewClassCode <= 0) {
			throw new CFLibArgumentUnderflowException(CFSecSecTentGrpIncTableObj.class, "setRuntimeClassCode", 1, "argNewClassCode", argNewClassCode, 1);
		}
	 ...
	 *	CFSecSecTentGrpIncObj.
	 */
	@Override
	public ICFSecSecTentGrpIncObj newInstance() {
		ICFSecSecTentGrpIncObj inst = new CFSecSecTentGrpIncObj( schema );
		return( inst );
	}
	...
	public ICFSecSecTentGrpIncEditObj newEditInstance( ICFSecSecTentGrpIncObj orig ) {
		ICFSecSecTentGrpIncEditObj edit = new CFSecSecTentGrpIncEditObj( orig );
		return( edit );
	}
	...
	{
		final String S_ProcName = "CFSecSecTentGrpIncTableObj.reallyDeepDisposeSecTentGrpInc() ";
		String classCode;
		if( obj == null ) {
			return;
		}
		...
		String IncName, boolean forceRead )
	{
		...
		pkey.setRequiredIncName( IncName );
	...
	@Override
	public List<ICFSecSecTentGrpIncObj> readSecTentGrpIncByNameIdx( String IncName )
	{
		return( readSecTentGrpIncByNameIdx( IncName,
			false ) );
	}
	...
	@Override
	public List<ICFSecSecTentGrpIncObj> readCachedSecTentGrpIncByNameIdx( String IncName )
	{
	...
	@Override
	public void deepDisposeSecTentGrpIncByNameIdx( String IncName )
	{
		final String S_ProcName = "deepDisposeSecTentGrpIncByNameIdx";
		ICFSecSecTentGrpIncObj obj;
		List<ICFSecSecTentGrpIncObj> arrayList = readCachedSecTentGrpIncByNameIdx( IncName );
		if( arrayList != null )  {
			Iterator<ICFSecSecTentGrpIncObj> arrayIter = arrayList.iterator();
			while( arrayIter.hasNext() ) {
				obj = arrayIter.next();
	 ...
	 */
	@Override
	public List<ICFSecSecTentGrpIncObj> pageSecTentGrpIncByNameIdx( String IncName,
		CFLibDbKeyHash256 priorSecTentGrpId,
		String priorIncName )
	{
	...
	@Override
	public void deleteSecTentGrpIncByNameIdx( String IncName )
	{
		ICFSecSecTentGrpIncByNameIdxKey key = schema.getCFSecBackingStore().getFactorySecTentGrpInc().newByNameIdxKey();
		key.setRequiredIncName( IncName );
		if( indexByNameIdx == null ) {
		...
		deepDisposeSecTentGrpIncByNameIdx( IncName );
	}
}