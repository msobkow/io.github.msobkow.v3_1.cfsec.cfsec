...
public class CFSecSecRoleMembTableObj
	implements ICFSecSecRoleMembTableObj
{
	protected ICFSecSchemaObj schema;
	protected static int runtimeClassCode = ICFSecSecRoleMemb.CLASS_CODE;
	protected static final int backingClassCode = ICFSecSecRoleMemb.CLASS_CODE;
	...
	public CFSecSecRoleMembTableObj() {
		schema = null;
	...
	public CFSecSecRoleMembTableObj( ICFSecSchemaObj argSchema ) {
	...
	static void setRuntimeClassCode(int argNewClassCode ) {
		if (argNewClassCode <= 0) {
			throw new CFLibArgumentUnderflowException(CFSecSecRoleMembTableObj.class, "setRuntimeClassCode", 1, "argNewClassCode", argNewClassCode, 1);
		}
	...
	public ICFSecSecRoleMembObj newInstance() {
		ICFSecSecRoleMembObj inst = new CFSecSecRoleMembObj( schema );
		return( inst );
	}
	...
	public ICFSecSecRoleMembEditObj newEditInstance( ICFSecSecRoleMembObj orig ) {
		ICFSecSecRoleMembEditObj edit = new CFSecSecRoleMembEditObj( orig );
		return( edit );
	}
	...
	{
		final String S_ProcName = "CFSecSecRoleMembTableObj.reallyDeepDisposeSecRoleMemb() ";
		String classCode;
		if( obj == null ) {
			return;
		}
