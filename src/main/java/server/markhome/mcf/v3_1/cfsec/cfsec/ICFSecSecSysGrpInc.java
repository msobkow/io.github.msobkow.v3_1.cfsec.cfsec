// Description: Java 25 interface for a SecSysGrpInc record declementation
...
/**
 *	ICFSecSecSysGrpInc persistence instances have CodeVis Protected, meaning that any only user interfaces and application code specific to the defining schema can access it.
 */
public interface ICFSecSecSysGrpInc
{
