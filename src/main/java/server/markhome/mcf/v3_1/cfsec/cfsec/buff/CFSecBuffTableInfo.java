// Description: Java 25 implementation of a TableInfo buffer
	...
	implements ICFSecTableInfo, Comparable<Object>, Serializable
{
	...
	public List<ICFSecTableInfo> getOptionalChildrenSubRefs() {
		ICFSecSchema targetBackingSchema = ICFSecSchema.getBackingCFSec();
		if (targetBackingSchema == null) {
			throw new CFLibNullArgumentException(getClass(), "setOptionalChildrenSubRefs", 0, "ICFSecSchema.getBackingCFSec()");
		}
		ICFSecTableInfoTable targetTable = targetBackingSchema.getTableTableInfo();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "setOptionalChildrenSubRefs", 0, "ICFSecSchema.getBackingCFSec().getTableTableInfo()");
		}
	...
	public String toString() {
		String ret = "<CFSecBuffTableInfo" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
