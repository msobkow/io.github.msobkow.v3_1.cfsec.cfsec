// Description: Java 25 implementation of a TableInfo history buffer primary key
...
/**
 *	CFSecBuffTableInfoHPKey History Primary Key for TableInfo
 *		requiredTableInfoId	Required object attribute TableInfoId.
 */
public class CFSecBuffTableInfoHPKey
	implements ICFSecTableInfoHPKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffTableInfoHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
