// Description: Java 25 interface for a SecTentGrp history primary key object
...
/**
 *	ICFSecSecTentGrpHPKey History Primary Key interface for SecTentGrp has CodeVis Protected, meaning that any only user interfaces and application code specific to the defining schema can access it.
 *		requiredSecTentGrpId	Required object attribute SecTentGrpId. */
public interface ICFSecSecTentGrpHPKey
{
