// Description: Java 25 interface for a SecTentGrpInc history object
...
/**
 *	ICFSecSecTentGrpIncH provides access to history records matching the CFSecSecTentGrpInc object change history.
 */
public interface ICFSecSecTentGrpIncH
{
