// Description: Java 25 Instance Edit Object interface for CFSec SecRoleMemb.
...
public interface ICFSecSecRoleMembEditObj
	extends ICFSecSecRoleMembObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFSecSecRoleMembObj.
	 */
	ICFSecSecRoleMembObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFSecSecRoleMembObj.
	 */
	ICFSecSecRoleMembObj getOrigAsSecRoleMemb();
	 ...
	 */
	ICFSecSecRoleMembObj create();

	/*
	 *	Update the instance.
	 */
	CFSecSecRoleMembEditObj update();

	/*
	 *	Delete the instance.
	 */
	CFSecSecRoleMembEditObj deleteInstance();
