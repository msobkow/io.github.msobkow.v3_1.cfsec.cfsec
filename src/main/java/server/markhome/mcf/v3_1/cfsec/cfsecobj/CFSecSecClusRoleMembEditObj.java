// Description: Java 25 edit object instance implementation for CFSec SecClusRoleMemb.
...
public class CFSecSecClusRoleMembEditObj
	implements ICFSecSecClusRoleMembEditObj
{
	...
	public CFSecSecClusRoleMembEditObj( ICFSecSecClusRoleMembObj argOrig ) {
		orig = argOrig;
		getRec();
	...
	public ICFSecSecClusRoleMembObj realise() {
		...
		ICFSecSecClusRoleMembObj retobj = getSchema().getSecClusRoleMembTableObj().realiseSecClusRoleMemb( (ICFSecSecClusRoleMembObj)this );
		return( retobj );
	}
	...
	public ICFSecSecClusRoleMembObj create() {
		copyRecToOrig();
		ICFSecSecClusRoleMembObj retobj = ((ICFSecSchemaObj)getOrigAsSecClusRoleMemb().getSchema()).getSecClusRoleMembTableObj().createSecClusRoleMemb( getOrigAsSecClusRoleMemb() );
	...
	public ICFSecSecClusRoleObj getRequiredContainerRole( boolean forceRead ) {
		if( forceRead || ( requiredContainerRole == null ) ) {
			...
			if( ! anyMissing ) {
				ICFSecSecClusRoleObj obj = ((ICFSecSchemaObj)getOrigAsSecClusRoleMemb().getSchema()).getSecClusRoleTableObj().readSecClusRoleByIdIdx( getPKey().getRequiredSecClusRoleId() );
	...
	public ICFSecSecUserObj getRequiredParentUser( boolean forceRead ) {
		if( forceRead || ( requiredParentUser == null ) ) {
			boolean anyMissing = false;
			if( ! anyMissing ) {
				ICFSecSecUserObj obj = ((ICFSecSchemaObj)getOrigAsSecClusRoleMemb().getSchema()).getSecUserTableObj().readSecUserByULoginIdx( getPKey().getRequiredLoginId() );
