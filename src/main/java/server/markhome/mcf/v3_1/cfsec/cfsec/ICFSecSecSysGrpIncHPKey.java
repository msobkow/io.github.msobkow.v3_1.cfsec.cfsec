// Description: Java 25 interface for a SecSysGrpInc history primary key object
...
/**
 *	ICFSecSecSysGrpIncHPKey History Primary Key interface for SecSysGrpInc has CodeVis Protected, meaning that any only user interfaces and application code specific to the defining schema can access it.
