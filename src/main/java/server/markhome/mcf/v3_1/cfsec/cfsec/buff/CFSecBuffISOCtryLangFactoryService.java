...
// Description: Java 25 Factory service implementation for ISOCtryLang buffers
...
/*
 *	Java 25 Factory service implementation for ISOCtryLang buffers.
 */
@Service("cfsec31BuffISOCtryLangFactoryService")
public class CFSecBuffISOCtryLangFactoryService
	implements ICFSecISOCtryLangFactory
{
	public CFSecBuffISOCtryLangFactoryService() {
	}
