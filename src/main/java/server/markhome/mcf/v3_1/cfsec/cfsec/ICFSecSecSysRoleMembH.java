// Description: Java 25 interface for a SecSysRoleMemb history object
...
/**
 *	ICFSecSecSysRoleMembH provides access to history records matching the CFSecSecSysRoleMemb object change history.
 */
public interface ICFSecSecSysRoleMembH
{
