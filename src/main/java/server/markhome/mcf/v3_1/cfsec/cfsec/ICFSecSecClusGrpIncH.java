// Description: Java 25 interface for a SecClusGrpInc history object
...
/**
 *	ICFSecSecClusGrpIncH provides access to history records matching the CFSecSecClusGrpInc object change history.
 */
public interface ICFSecSecClusGrpIncH
{
