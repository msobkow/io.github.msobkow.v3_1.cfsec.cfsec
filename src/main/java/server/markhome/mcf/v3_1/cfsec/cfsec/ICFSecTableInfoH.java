// Description: Java 25 interface for a TableInfo history object
...
/**
 *	ICFSecTableInfoH provides access to history records matching the CFSecTableInfo object change history.
 */
public interface ICFSecTableInfoH
{
