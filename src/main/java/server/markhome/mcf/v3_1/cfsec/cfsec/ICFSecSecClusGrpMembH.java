// Description: Java 25 interface for a SecClusGrpMemb history object
...
/**
 *	ICFSecSecClusGrpMembH provides access to history records matching the CFSecSecClusGrpMemb object change history.
 */
public interface ICFSecSecClusGrpMembH
{
