// Description: Java 25 interface for a SecTentGrpMemb history object
...
/**
 *	ICFSecSecTentGrpMembH provides access to history records matching the CFSecSecTentGrpMemb object change history.
 */
public interface ICFSecSecTentGrpMembH
{
