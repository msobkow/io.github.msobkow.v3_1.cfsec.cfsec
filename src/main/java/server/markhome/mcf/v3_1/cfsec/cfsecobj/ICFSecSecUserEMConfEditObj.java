// Description: Java 25 Instance Edit Object interface for CFSec SecUserEMConf.
...
public interface ICFSecSecUserEMConfEditObj
	extends ICFSecSecUserEMConfObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFSecSecUserEMConfObj.
	 */
	ICFSecSecUserEMConfObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFSecSecUserEMConfObj.
	 */
	ICFSecSecUserEMConfObj getOrigAsSecUserEMConf();
	 ...
	 *	Delete the instance.
	 */
	CFSecSecUserEMConfEditObj deleteInstance();
