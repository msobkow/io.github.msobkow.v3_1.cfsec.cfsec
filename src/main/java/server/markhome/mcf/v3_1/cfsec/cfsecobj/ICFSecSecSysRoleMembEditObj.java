// Description: Java 25 Instance Edit Object interface for CFSec SecSysRoleMemb.
...
public interface ICFSecSecSysRoleMembEditObj
	extends ICFSecSecSysRoleMembObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFSecSecSysRoleMembObj.
	 */
	ICFSecSecSysRoleMembObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFSecSecSysRoleMembObj.
	 */
	ICFSecSecSysRoleMembObj getOrigAsSecSysRoleMemb();
	 ...
	 *	Delete the instance.
	 */
	CFSecSecSysRoleMembEditObj deleteInstance();
