	...
	implements ICFSecSecUserPassword, Comparable<Object>, Serializable
{
	...
	public void setRequiredContainerUser(CFLibDbKeyHash256 argSecUserId) {
		...
		if (targetBackingCFSec == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerUser-args", 0, "ICFSecPubSchema.getBackingCFSec()");
		}
		ICFSecPubSecUserTable targetTable = targetBackingCFSec.getTableSecUser();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerUser", 0, "ICFSecPubSchema.getBackingCFSec().getTableSecUser()");
		}
