// Description: Java 25 interface for a SecRole history primary key object
...
/**
 *	ICFSecSecRoleHPKey History Primary Key interface for SecRole
 *		requiredSecRoleId	Required object attribute SecRoleId. */
public interface ICFSecSecRoleHPKey
{
