...
/**
 *	ICFSecTableInfo persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFSecTableInfo
{
	...
	public default void setOptionalParentSuperRef(ICFSecProtTableInfo argObj) {
		if (argObj == null) {
			setOptionalParentSuperRef((ICFSecTableInfo)null);
		}
		else {
			setOptionalParentSuperRef(argObj.getOptionalSuperName());
		}
	}
