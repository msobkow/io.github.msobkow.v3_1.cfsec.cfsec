// Description: Java 25 implementation of a TableInfo by SchemaRTCodeIdx index key buffer
	...
	implements ICFSecTableInfoBySchemaRTCodeIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffTableInfoBySchemaRTCodeIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
