...
public class CFSecSecUserPWResetObj
	implements ICFSecSecUserPWResetObj
{
	...
	public CFSecSecUserPWResetObj() {
		isNew = true;
		requiredContainerUser = null;
	}

	public CFSecSecUserPWResetObj( ICFSecSchemaObj argSchema ) {
		schema = argSchema;
		isNew = true;
		edit = null;
		requiredContainerUser = null;
	...
	public ICFSecSecUserPWResetObj realise() {
		ICFSecSecUserPWResetObj retobj = ((ICFSecSchemaObj)getSchema()).getSecUserPWResetTableObj().realiseSecUserPWReset(
	...
	@Override
	public void forget() {
		((ICFSecSchemaObj)getSchema()).getSecUserPWResetTableObj().reallyDeepDisposeSecUserPWReset( (ICFSecSecUserPWResetObj)this );
	}

	@Override
	public ICFSecSecUserPWResetObj read() {
		ICFSecSecUserPWResetObj retobj = ((ICFSecSchemaObj)getSchema()).getSecUserPWResetTableObj().readSecUserPWResetByIdIdx( getPKey(), false );
		return( (ICFSecSecUserPWResetObj)retobj );
	}

	@Override
	public ICFSecSecUserPWResetObj read( boolean forceRead ) {
		ICFSecSecUserPWResetObj retobj = ((ICFSecSchemaObj)getSchema()).getSecUserPWResetTableObj().readSecUserPWResetByIdIdx( getPKey(), forceRead );
		return( (ICFSecSecUserPWResetObj)retobj );
	}

	@Override
	public ICFSecSecUserPWResetTableObj getSecUserPWResetTable() {
		return( ((ICFSecSchemaObj)getSchema()).getSecUserPWResetTableObj() );
	}
	...
	public ICFSecSecUserPWReset getRec() {
		if( rec == null ) {
			if( isNew ) {
				...
				rec = getSchema().getCFSecBackingStore().getTableSecUserPWReset().readDerivedByIdIdx( ((ICFSecSchemaObj)getSchema()).getAuthorization(),
						getPKey() );
				if( rec != null ) {
					copyRecToPKey();
				}
	...
	public ICFSecSecUserPWResetEditObj beginEdit() {
		...
		if( getIsNew() ) {
			...
			lockobj = ((ICFSecSchemaObj)getSchema()).getSecUserPWResetTableObj().lockSecUserPWReset( getPKey() );
		}
		edit = ((ICFSecSchemaObj)getSchema()).getSecUserPWResetTableObj().newEditInstance( lockobj );
