// Description: Java 25 interface for a SecSysGrpMemb history primary key object
...
/**
 *	ICFSecSecSysGrpMembHPKey History Primary Key interface for SecSysGrpMemb has CodeVis Protected, meaning that any only user interfaces and application code specific to the defining schema can access it.
 *		requiredSecSysGrpId	Required object attribute SecSysGrpId.
 *		requiredLoginId	Required object attribute LoginId. */
public interface ICFSecSecSysGrpMembHPKey
{
