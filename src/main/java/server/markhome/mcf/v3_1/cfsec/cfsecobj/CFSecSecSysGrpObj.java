	...
	implements ICFSecSecSysGrpObj
{
	...
	public ICFSecSecSysRoleObj getOptionalChildrenImplSysRole( boolean forceRead ) {
		if( ( optionalChildrenImplSysRole == null ) || forceRead ) {
			boolean anyMissing = false;
			if( ! anyMissing ) {
				optionalChildrenImplSysRole = ((ICFSecSchemaObj)getSchema()).getSecSysRoleTableObj().readSecSysRoleByIdIdx( getPKey(), forceRead );
			}
		}
