// Description: Java 25 interface for a SecUserPWHistory history object
...
/**
 *	ICFSecSecUserPWHistoryH provides access to history records matching the CFSecSecUserPWHistory object change history.
 */
public interface ICFSecSecUserPWHistoryH
{
