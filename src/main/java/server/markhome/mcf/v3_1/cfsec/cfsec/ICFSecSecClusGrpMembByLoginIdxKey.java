...
/**
 *	ICFSecSecClusGrpMembByLoginIdxKeys has CodeVis Protected, meaning that any only user interfaces and application code specific to the defining schema can access it.
 */
