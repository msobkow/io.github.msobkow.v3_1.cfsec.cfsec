// Description: Java 25 interface for a SecRoleEnables history object
...
/**
 *	ICFSecSecRoleEnablesH provides access to history records matching the CFSecSecRoleEnables object change history.
 */
public interface ICFSecSecRoleEnablesH
{
