// Description: Java 25 interface for a SecUserPWReset history object
...
/**
 *	ICFSecSecUserPWResetH provides access to history records matching the CFSecSecUserPWReset object change history.
 */
public interface ICFSecSecUserPWResetH
{
