// Description: Java 25 interface for a SecSysRole record declementation
...
/**
 *	ICFSecSecSysRole persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
